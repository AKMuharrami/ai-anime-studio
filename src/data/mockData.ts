...
export const INITIAL_CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    visual_descriptor: '32-year-old tactical strategist and elite cyber-enforcer, neat dark trim beard, dark navy high-collared armored jacket over tactical combat suit, commanding amber eyes, dignified posture, full-coverage armor.',
    master_model_sheet_url: '',
    consistency_method: 'UNIFIED_MASTER_SHEET',
    reference_images: [],
    turnaround_angles: {
    ...
    full_script_json: {
      ...
      scenes: [
        ...
        },
        {
          ...
          action_prompt: 'High-tension confrontation inside the cryogenic server hall. Commander Tariq turns as Ren enters, adjusting his armored jacket as neural cables glow around the terminal. Frost vapor swirls between them.',
